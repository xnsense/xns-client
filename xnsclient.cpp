...
void xnsClientClass::begin(const char* appName, const int version[], int accessPointButtonPin, Stream& debugger)
{
...
void xnsClientClass::beginSecure(const char* appName, const int version[], const char* ssid, const char* ssidPassword, const char* mqtt, int mqttPort, const char* mqttClientID, const char* mqttUser, const char* mqttPass, const char* mqttPublishTopic, const char* mqttSubscribeTopic, Stream& debugger)
{
...
void xnsClientClass::begin(const char* appName, const int version[], const char* ssid, const char* ssidPassword, const char* mqtt, int mqttPort, const char* mqttUser, const char* mqttPass, Stream& debugger)
{
	this->debugger = &debugger;
	begin(appName, version, ssid, ssidPassword, mqtt, mqttPort, mqttUser, mqttPass);
}
void xnsClientClass::begin(const char* appName, const int version[], const char* ssid, const char* ssidPassword, const char* mqtt, int mqttPort, const char* mqttUser, const char* mqttPass)
{
	this->mqttUser = mqttUser;
	this->mqttPass = mqttPass;
	begin(appName, version, ssid, ssidPassword, mqtt, mqttPort);
}
void xnsClientClass::begin(const char* appName, const int version[], const char* ssid, const char* ssidPassword, const char* mqtt, int mqttPort, Stream& debugger)
{
	this->debugger = &debugger;
	begin(appName, version, ssid, ssidPassword, mqtt, mqttPort);
}

void xnsClientClass::begin(const char* appName, const int version[], const char* ssid, const char* ssidPassword, const char* mqtt, int mqttPort)
{
	this->version = version;
	this->appName = appName;
	this->ssid = ssid;
